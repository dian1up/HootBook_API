...
route
    ...
    .get('/booking/history', auth.verifyTokenMiddleware, bookingController.getBookingHistory)
    .get('/booking/service/:serviceId', auth.verifyTokenMiddleware, bookingController.getAllBookingsOnService)
